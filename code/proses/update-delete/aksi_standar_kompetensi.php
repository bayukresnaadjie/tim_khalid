                        ...
                        <td>
                            <select name="kelas_sk">
                                <?php if ($isi['kelas_sk'] == "X") { ?>
                                    ...
                                    <option value="X" selected>1A</option>
                                    <option value="XI">2A</option>
                                    <option value="XII">3A</option>
                                <?php
                                } else if ($isi['kelas_sk'] == "XI") { ?>
                                    <option value="" disabled>Pilih Kelas</option>
                                    <option value="X">1A</option>
                                    <option value="XI" selected>2A</option>
                                    <option value="XII">3A</option>
                                <?php
                                    ...
                                    <option value="X">1A</option>
                                    <option value="XI">2A</option>
                                    <option value="XII" selected>3A</option>
                            </select>&nbsp;&nbsp;
                        <?php
