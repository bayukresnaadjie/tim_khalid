...
<form action="code/proses/input/input_login.php" method="POST" onsubmit="return validasi_input(this)">
    ...
    <table id="tabel-pendaftaran">
        ...
        <tr>
            <td>
                <select name="nis">
                    ...
                    $tampilkan_isi = "select s.nis,nama_siswa from siswa s left outer join login l ON s.nis = l.nis WHERE l.nis is NULL;";
        ...
        <tr>
            <td>
                <select name="kode_guru">
                    ...
                    $tampilkan_isi = "select g.kode_guru,nama_guru from guru g left outer join login l ON g.kode_guru = l.kode_guru WHERE l.kode_guru is NULL;";
        ...
        <tr>
            <td>
                <font size="3px" color="red"><b>* isi salah satu antara Dosen dan Mahasiswa</b></font>
            </td>
        </tr>
