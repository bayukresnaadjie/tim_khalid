...
<form action="halaman_utama.php?tabel_guru=$tabel_guru" method="post">
	...
	font-family:Calibri;
		...
		<tr>
			<td></td>
			<td align="right">
				<font face="Calibri" size="2"><u>Harap gunakan <b>Nama Guru</b> dalam pencarian Dosen</u>!</font>
			</td>
		</tr>
	</table>
</form>
...
<table id="daftar-table" border='0' bordercolor="black" cellpading='2' cellspacing='2' width='100%'>
	<tr align='center'>
		<th class="normal">Kode Dosen</th>
		<th class="normal">Nama Dosen</th>
