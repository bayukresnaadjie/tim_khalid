<b>
	<font color="#2133F8"> MAHASISWA</font>
</b> <br><br>
...
<form action="halaman_utama.php?tabel_siswa=$tabel_siswa" method="post">
	...
	font-family:Calibri;
		...
		<tr>
			<td></td>
			<td align="right">
				<font face="Calibri" size="2"><u>Harap gunakan <b>Nama Mahasiswa</b> dalam pencarian Mahasiswa</u> !</font>
			</td>
		</tr>
	</table>
</form>
...
<table id="daftar-table" border='0' bordercolor="black" cellpading='2' cellspacing='2' width='100%'>
	<tr align='center'>
		...
		<th class="normal">Nama Mahasiswa</th>
